...
xvar_labels = {
    ...
    "secc_log_city_population": "Log City Population",
    "pc91_pc11_log_pop_grw_rate": "Log City Growth 1991-2011",
    "secc_city_m_pop_shr": "Muslim Share",
    "secc_city_sc_population_share": "SC Share",
    "pc11_town_origin_year": "City Origin Year",
    "secc_log_city_cons_per_cap": "Log Per Capita Consumption",
    "secc_mobility_p25": "Upward Mobility (p25)",
    "violence_any_event": "Any Violent Event",
    "secc_town_consumption_gini": "Town Consumption Gini",
    "secc_rural_land_gini": "Rural District Land Gini",
    ...
    "std1": "Log City Population",
    "std2": "Log City Growth 1991-2011",
    "std3": "Muslim Share",
    "std4": "SC Share",
    "std5": "City Origin Year",
    "std6": "Log Per Capita Consumption",
    "std7": "Upward Mobility (p25)",
    "std8": "Any Violent Event",
    "std9": "Town Consumption Gini",
    "std10": "Rural District Land Gini",
}
