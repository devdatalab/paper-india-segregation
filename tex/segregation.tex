...
\IfFileExists{segpath-local.tex}{
  \input{segpath-local.tex}
}{
...
\begin{landscape}
  \begin{center}
    \captionof{table}{Neighborhood-level Public Services and Marginalized Group Shares: \cnewline Estimates Controlling for Neighborhood Consumption}
