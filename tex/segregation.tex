%% This is the version of segregation paper for public circulation in the replication folder.
%% It is identical to the manuscript version, but path names have been made generic for public use.
%% Submissions to AER should *NOT* use this version, use the one in the primary work repo.
...
\clearpage
  ...
  \begin{sidewaystable}[p]
    ...
    \begin{center}
      \input{exhibits/src_seg_compare.tex}
    \end{center}
